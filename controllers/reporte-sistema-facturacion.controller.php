...
class ReporteFacturasController{
	...
	=============================================*/
		...
		static public function ctrCargarFacturas($id_empresa, $fechaDesde, $fechaHasta, $consecutivo, $clave, $cedula, $estado, $tipoDoc){

	       $table = "empresas.tbl_sistema_facturacion_facturas"; 

	      
			$response = ReporteFacturasModel::MdlCargarFacturas($table, $id_empresa, $fechaDesde, $fechaHasta, $consecutivo, $clave, $cedula, $estado, $tipoDoc);	
	...
	=============================================*/
		...
		static public function ctrCargarDatosEmpresa($idEmpresa){
			...
			$table = "empresas.tbl_clientes"; 	
			 ...
			 $response = ReporteFacturasModel::MdlCargarDatosEmpresa($table, $idEmpresa);	
