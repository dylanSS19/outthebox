...
static public function MdlUpdateDatosFacturaGastos($table, $clave, $procesado, $estado, $consecutivoReceptor, $categoria, $comentario) {

		$stmt = Connexion::connect()->prepare("UPDATE $table SET procesado=:procesado, estadoProcesado=:estadoProcesado, consecutivoReceptor=:consecutivoReceptor,categoria=:categoria,comentario=:comentario WHERE clave=:clave");				
