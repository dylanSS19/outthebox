...
// $ultimo_consecutivo = "221";
	...
	static public function MdlcargarDatosUsuarioReenvio($table, $cedula) {

		$stmt = Connexion::connect()->prepare("SELECT * FROM $table WHERE cedula_cliente = '$cedula'");				
...
static public function MdlUpdateDatosFacturaGastos($table, $clave, $procesado, $estado, $consecutivoReceptor, $categoria, $comentario, $tipo) {

		$stmt = Connexion::connect()->prepare("UPDATE $table SET procesado=:procesado, estadoProcesado=:estadoProcesado, consecutivoReceptor=:consecutivoReceptor,categoria=:categoria,comentario=:comentario,tipo=:tipo WHERE clave=:clave");				
...
static public function MdlEliminarUltConsecutivoFC($table, $sucursal, $caja, $tipo, $empresa) { 

	$stmt = Connexion::connect()->prepare("DELETE FROM $table WHERE sucursal = '$sucursal' and caja = '$caja' and tipo = '$tipo' and id_empresa = '$empresa'");
...
static public function MdlModificarEstadoFacturaReenvio($table, $clave) {
