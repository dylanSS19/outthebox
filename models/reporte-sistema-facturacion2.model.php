...
class ReporteFacturasModel{
		...
		static public function MdlCargarFacturas($table, $id_empresa, $fechaDesde, $fechaHasta, $consecutivo, $cedula, $estado, $tipoDoc) { 
...
$where .= "AND consecutivo = '$consecutivo' ";
...
$where .= "AND estado_factura = '$estado' ";
