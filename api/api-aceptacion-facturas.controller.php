   ...
   //Your credentials goes here
    ...
    //   exit();
     ...
     public function GenerarXML($json, $idcliente){
        ...
        $tipo = $json["fileContent"]["datosFactura"]["tipo"];
    ...
    api_AceptacionFacturasController::UpdateDatosFacturaGastos($clave, $procesado, $estado, $consecutivoReceptor, $categoria, $comentario, $tipo);
    ...
    $insertarconsecutivo = api_facturacionModel::MdlUpdateconse($table, $id_factura, $random);
        ...
        public function UpdateDatosFacturaGastos($clave, $procesado, $estado, $consecutivoReceptor,$categoria,$comentario, $tipo){

        $table = 'empresas.tbl_sistema_facturacion_Factura_gastos';
    
        $insertarconsecutivo = api_facturacionModel::MdlUpdateDatosFacturaGastos($table, $clave, $procesado, $estado, $consecutivoReceptor, $categoria, $comentario, $tipo);
