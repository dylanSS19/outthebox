...
$id_empresa = $_SESSION['empresa'];
    ...
    $response = ReporteFacturasController::ctrCargarFacturas($id_empresa, $fechaDesde, $FechaHasta, $consecutivo, $cedula, $estado, $tipodoc);
...
}else if($response[$i]["estado_factura"] == "enviado"){
