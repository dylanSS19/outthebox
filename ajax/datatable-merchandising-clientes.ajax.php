...
$buttons = "<div class='btn-group'><button class='btn btn-outline-primary btnClient'  idclient='".$response[$i]['idtbl_empresas_clientes']."' data-toggle='modal' data-target='#modalEditClientesMerch'><i class='fas fa-info-circle'></i></button></div>";
