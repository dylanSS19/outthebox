...
$('#empleados_salida_empleado').change(function () {

  $("#nombreEmpleado").val($("option:selected", $(this)).text().trim());
 
});

$('#empleados_salida_motivo').change(function () {

  $("#motivoSalida").val($("option:selected", $(this)).text().trim());

});

$(document).ready(function(){
  $("#form-salida-personal").on("submit", function(){
    $("#overlay2").fadeIn();
  });//submit
});//document ready