  ...
  /*============================================= 
    =                   EDIT USER                 =
     ...
     $(document).on("click", ".btnEditSubCategoriaServicio", function(){

      var SubCategoriaServicioId = $(this).attr("SubCategoriaServicioId");

  var data = new FormData();

      data.append("SubCategoriaServicioId",SubCategoriaServicioId);

      $.ajax({

        url:"ajax/subcategoria-servicios.ajax.php",
        method: "POST",
        data: data,
        cache: false,
        contentType: false,
...
*/
           ...
           error: function(response, err){console.log('my message ' + err + " " + response + " " + SubCategoriaServicioId );}
...
$(document).on("click", ".btnActivatarCategoriaSubServicios", function(){
...
$(document).ready(function() {
 var table = $("#tablasubcategoriadeservicios").DataTable({

       "ajax": 'ajax/datatable-subcategoria-servicios.ajax.php?Rol='+Rol,  
       "async": "false",
...
$.ajax({
          ...
          url:'ajax/datatable-subcategoria-servicios.ajax.php?Rol='+Rol,
          async: false,
          success: function(response){
