...
$supervisor="";
 $totalventas = controladorVentasTiendas::ctrventastiendas($startDate, $endDate,$supervisor); 
       ...
       <!-- checkbox -->
              <div class="form-group">
                ...
                <label style="color: #a0d0e0">
                  <input type="checkbox" class="minimal" checked id="chk_kitsclaro_digital_grafico_ventas_tiendas"> KITS PROPIOS
                </label> &nbsp;&nbsp;
                   <label style="color: #FFC0CB">
                  <input type="checkbox" class="minimal" checked id="chk_kitsdigital_grafico_ventas_tiendas"> ACCESORIOS
                </label>
              </div>
...
if ($totalventas ==null){
 ...
 echo "{ y: 0, pospago: 0, kitsclaro: 0, kitsdigital: 0, accesorios: 0 }";
    ...
    foreach ($totalventas as $key => $value) {
      ...
      labels: ['POSPAGO', 'KITS CLARO', 'KITS PROPIOS' , 'ACCESORIOS'],
...
if(isCheckedchk_kitsclaro_claro_grafico_ventas_tiendas && isCheckedchk_kitsclaro_digital_grafico_ventas_tiendas && isCheckedchk_kitsdigital_grafico_ventas_tiendas){
 ...
 "use strict";
    ...
    foreach ($totalventas as $key => $value) {
      ...
      labels: ['KITS CLARO', 'KITS PROPIOS' , 'ACCESORIOS'],
...
$supervisor=$_SESSION["user_name"];
      ...
      $total_ventas_pospago = controladorVentasTiendas::ctrCargarVentasPospago($startDate, $endDate,$supervisor);
  ...
  $total_ventas_prepago_digital = controladorVentasTiendas::ctrCargarVentasPrepagoDigital($startDate, $endDate,$supervisor);
   ...
   $total_ventas_prepago_claro = controladorVentasTiendas::ctrCargarVentasPrepagoClaro($startDate, $endDate,$supervisor);
   ...
   $total_ventas_prepago_kitsdigital = controladorVentasTiendas::ctrCargarVentasAccesorios($startDate, $endDate,$supervisor);
...
*/
   ...
   echo ' <h4 style="font-size: 22px">'.'₡'. number_format($total_ventas_prepago_kitsdigital[0],2) .'</h4>';
      ...
      $total_ventas_recuadaciones = controladorVentasTiendas::ctrCargarVentasRecaudaciones($startDate, $endDate,$supervisor);
  ...
  $total_ventas_arpu = controladorVentasTiendas::ctrCargarVentasArpuPospago($startDate, $endDate,$supervisor);
   ...
   $total_ventas_arpu_prepago_digital = controladorVentasTiendas::ctrCargarVentasArpuPrepagoDigital($startDate, $endDate,$supervisor);
   ...
   $total_ventas_arpu_prepago_claro = controladorVentasTiendas::ctrCargarVentasArpuPrepagoClaro($startDate, $endDate,$supervisor);
/*   echo '<pre>'; print_r($total_ventas_prepago_kitsdigital); echo '</pre>';
*/
   ...
   $total_ventas_activaciones = controladorVentasTiendas::ctrCargarVentasActivaciones($startDate, $endDate, $supervisor);
   //echo '<pre>'; print_r($total_ventas_activaciones); echo '</pre>';
...
$tiendas = controladorVentasTiendas::ctrCargarTiendas($supervisor);

}elseif ($_SESSION["rol"]=="Supervisor-Tiendas"){

$supervisor=$_SESSION["user_name"];
$tiendas = controladorVentasTiendas::ctrCargarTiendas($supervisor);
/*  echo '<pre>'; print_r($ctrCargarTiendas); echo '</pre>';
...
?>
  ...
  <select class="form-control input-lg reporte_tiendas select2"    name="reporte_tiendas" id="reporte_tiendas" required >
...
<option selected value="">Todas</option>
 ...
 echo '<option value=' .$value["idtbl_tiendas"] .' >'. trim($value["nombre"]) .' </option>';
...
var tienda = paramstienda.get('ID');
...
$supervisor="";
  ...
  $metas_tiendas = controladorVentasTiendas::ctrCargarMetasTiendas($startDate, $endDate, $tienda,$supervisor);
...
echo '<div class ="row">
 ...
 <div class="progress-group">
  ...
  if ($_SESSION["rol"]=="Administrador" || $_SESSION["rol"]=="Administrativo" || $_SESSION["rol"]=="Supervisor-Tiendas" || $_SESSION["rol"]=="UsuarioOTB" ){
...
$tienda = "null";
...
}else if ($value["nombre"] == "KITS CLARO"){
 ...
 $total_ventas = controladorVentasTiendas::ctrCargarVentasPrepagoClaroTiendas($startDate, $endDate, $tienda);
 ...
 //echo '<pre>'; print_r($total_ventas); echo '</pre>';
...
<br>
  ...
  <?php if ($_SESSION["rol"]=="Administrador" || $_SESSION["rol"]=="Administrativo" || $_SESSION["rol"]=="UsuarioOTB"){ ?>
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarEstadoTiendas($supervisor);
            /*  echo '<pre>'; print_r($ventas); echo '</pre>';
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarPendientesEncomiendas($supervisor);
           /*   echo '<pre>'; print_r($ventas); echo '</pre>';
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTotales($startDate, $endDate,$supervisor);
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTablaKitsDigital($startDate, $endDate,$supervisor);
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTablaKitsClaro($startDate, $endDate,$supervisor);
/*              echo '<pre>'; print_r($ventas); echo '</pre>';
*/             
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTablaAccesorios($startDate, $endDate,$supervisor);
/*              echo '<pre>'; print_r($ventas); echo '</pre>';
*/             
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTablaRecaudaciones($startDate, $endDate,$supervisor);
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTablaTae($startDate, $endDate,$supervisor);
/*              echo '<pre>'; print_r($ventas); echo '</pre>';
*/             
...
$supervisor=$_SESSION["user_name"];
              ...
              $ventas="";
              $ventas = controladorVentasTiendas::ctrCargarVentasTablaActivaciones($startDate, $endDate,$supervisor);
...
<?php } ?>
            ...
            <?php  if ($_SESSION["rol"]=="Administrador" || $_SESSION["rol"]=="Administrativo"  || $_SESSION["rol"]=="UsuarioOTB" || $_SESSION["rol"]=="Supervisor-Tiendas" ) { ?>
