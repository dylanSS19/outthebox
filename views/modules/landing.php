    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center">
          <!--  <h1 class="logo mr-auto"><a href="index.html">OUT THE BOX<span>.</span></a></h1>-->
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li><a href="#about">Acerca Nosotros</a></li>
          ...
          <a href="login" class="get-started-btn scrollto d-none d-lg-block">Iniciar Sesión</a>
          <a href="registro" class="get-started-btn scrollto d-none d-lg-block ">Registrarse</a>
        </div>
      </div>
    ...
    <div class="container-fluid" data-aos="zoom-out" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-10">
          <div class="row">
            <div class="col-xl-5">
              <h1>La mejor experiencia en Ops Comerciales</h1>
              <h2>Somos un equipo comprometidos con ayudarlo!</h2>
              <a href="login" class="btn-get-started scrollto">Iniciar Sesión</a>
              <a href="registro" class="btn-get-started scrollto">Registrarse</a>
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <p>Emita documentos al Ministerio de Hacienda con nuestro API o Facturador</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Aceptación de Documentos</h4>
                  <p>Acepte XML de proveedores</p>
                </div>
